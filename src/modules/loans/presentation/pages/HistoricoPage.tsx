                ...
                <tr key={loan.id}>
                  <td>
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-[4px] bg-surface-2 flex items-center justify-center shrink-0">
                        📖
                      </div>
                  ...
                  <td>
                    <div className="user-cell">
                      <div
                        className="avatar"
                        style={{ width: '24px', height: '24px', fontSize: '9px', background: 'var(--surface-3)' }}
                      >
                  ...
                  <td>
                    <div className="text-[11px] uppercase text-text-muted font-bold">
                      Retirada: {formatDateBR(loan.loanDate)}
                    </div>
                    <div className="text-[11px] uppercase text-text-muted font-bold">
                      Prevista: {formatDateBR(loan.dueDate)}
                    </div>
                  </td>
                  <td>
                    <div className="flex flex-col gap-1.5">
                      ...
                      {loan.returnDate && (
                        <span className="text-[11px] text-text-secondary font-medium">
                          Finalizado em {formatDateBR(loan.returnDate)}
                        </span>
                      )}
                    </div>
                  </td>
