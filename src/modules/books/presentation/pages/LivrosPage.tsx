  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      if (deleted) {
        ...
        toast.error(
          error ||
            'Não foi possível excluir o livro. Ele pode possuir empréstimo ativo ou histórico vinculado.',
        );
      }
    } finally {
      setIsDeleting(false);
            ...
            {loading ? (
              ...
              filteredBooks.map((book) => (
                <tr key={book.id}>
                  <td>
                    <div className="book-cell">
                      <div
                        ...
                        style={{
                          background: 'linear-gradient(135deg, var(--accent), #f3c26a)',
                        }}
                      >
                        📖
                      </div>
                      <div className="book-cell-info">
                        ...
                        <div className="book-cell-meta">
                          ISBN: {book.id.substring(0, 8).toUpperCase()}
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <span
                      className={`badge ${book.status === 'AVAILABLE' ? 'badge-success' : 'badge-warning'}`}
                    >
